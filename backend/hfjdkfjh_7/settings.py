"""
Django settings for hfjdkfjh_7 project.
...
WSGI_APPLICATION = 'hfjdkfjh_7.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "hfjdkfjh_7 API",
    "DESCRIPTION": "API documentation for hfjdkfjh_7 App",
    "VERSION": "v1",
}
